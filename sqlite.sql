...
-- Criar a tabela Empregado incluindo email e password
...
-- Criar a tabela Pasta com a nova coluna Armario e ID_Ultimo_Evento
CREATE TABLE Pasta (
...
-- Criar a tabela Historico para rastreamento detalhado
...
-- Inserir dados de exemplo para Empregado (usuários administradores devem ter senha criptografada)
INSERT INTO Empregado (nome, Perfil, email, password) VALUES
('Carlos Lima', 'Admin', 'carlos.lima@maconcontabilidade.com.br', '$2y$10$Z1L.bMecXvX6Jz/KoEPn5OXx3aenIlibG7tIhpK3iRl3J4cs5MRYC'),  -- password1
('Ana Oliveira', 'User', 'ana.oliveira@maconcontabilidade.com.br', '$2y$10$S4L.bMecXvX6Jz/WKYPn5OXx3aenIlibG7tIhpK3iRl3J7dcs6NRYX'),  -- password2
('Roberto Farias', 'User', 'roberto.farias@maconcontabilidade.com.br', '$2y$10$K1L.bMecXvX6Jz/KoEPn5OXx3aenIlibG7tIhpK3iRl3J6cs5MRYZ'),  -- password3
('Mariana Lopes', 'User', 'mariana.lopes@maconcontabilidade.com.br', '$2y$10$F4L.bMecXvX6Jz/KoEPn5OXx3aenIlibG7tIhpK3iRl3J5cs5MRYW'),  -- password4
('Eduardo Almeida', 'Admin', 'eduardo.almeida@maconcontabilidade.com.br', '$2y$10$D1L.bMecXvX6Jz/KoEPn5OXx3aenIlibG7tIhpK3iRl3J4cs5MRYA'); -- password5

-- Inserir dados de exemplo para Pasta (60 pastas para 30 clientes)
INSERT INTO Pasta (ID_Cliente, Armario) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
-- Inserir dados de exemplo para Historico com datas e horários específicos
INSERT INTO Historico (ID_Pasta, ID_Cliente, ID_Empregado, Tipo_Evento, DataHora_Evento) VALUES
...
-- Atualizar a tabela Pasta com os IDs do último evento (ID_Ultimo_Evento)
UPDATE Pasta
